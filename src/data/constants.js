import GitamLogo from "../images/Gitamlogo.png";
...
const StellarVaultLogo = "/gandhar-Portfolio-Website/stellar-vault-logo-cropped.png";
...
export const Bio = {
  ...
  github: "https://github.com/gandharr",
  resume:
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Developed a modern Next.js web application for GITAM University students to track and calculate attendance with an intuitive, responsive interface. Implemented seamless routing to the Student Login portal and clean, maintainable UI components.",
    image: GitamAttendanceLogo,
    tags: ["TypeScript", "JavaScript", "CSS", "Next.js", "React", "Tailwind CSS"],
    category: "web app",
